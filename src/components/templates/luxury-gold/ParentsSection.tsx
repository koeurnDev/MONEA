...
export default function ParentsSection({ wedding, labels }: ParentsSectionProps) {
    ...
    return (
        <motion.section className="py-24 px-6 relative overflow-hidden" {...fadeInUp}>
            {/* Background Elements */}
            ...
            <div className="relative z-10 p-12 border border-[#D4AF37]/40 bg-gradient-to-b from-[#1a1a1a]/80 to-[#111]/90 backdrop-blur-xl max-w-lg mx-auto shadow-[0_10px_40px_rgba(0,0,0,0.5)] rounded-sm">
