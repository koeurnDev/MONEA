...
import { Lock, Mail, ArrowRight, UserCog, Loader2, Key, Users, ChevronLeft } from "lucide-react";
            ...
            >
                <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-4 md:p-6 shadow-2xl relative overflow-hidden">
                    ...
                    <div className="text-center mb-3 md:mb-5">
                        ...
                        <p className="text-white/40 text-[100:px] md:text-xs font-kantumruy">{t('common.auth.loginSubtitle')}</p>
                    </div>
