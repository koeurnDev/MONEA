    ...
    return (
        <div className="relative w-full h-screen bg-[#050505] overflow-hidden flex items-center justify-center font-kantumruy text-center p-6">
            ...
            >
                ...
                <p className="text-zinc-400 text-lg md:text-xl font-bold mb-12 leading-relaxed opacity-60">
                    សូមចុចប៊ូតុងខាងក្រោមដើម្បីចាប់ផ្តើមការបង្ហាញ <br /> ភ្ញៀវកិត្តិយស និងកាដូជូនពរថ្មីៗ
                </p>
                <button
                    onClick={onStart}
                ...
                >
                    <span className="relative z-10 flex items-center gap-3">
                        ចាប់ផ្តើមដំណើរការ <Trophy className="w-6 h-6" />
                    </span>
