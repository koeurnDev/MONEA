...
import { UserPlus, Mail, Lock, ChevronLeft, ArrowRight, Camera, Eye, EyeOff } from "lucide-react";
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="space-y-1">
                                            ...
                                            <div className="relative">
                                                <Input type={showPassword ? "text" : "password"} placeholder="••••••••" className="bg-white/5 border-white/10 text-white rounded-xl focus:border-pink-500/50 h-8 md:h-10 text-sm pr-10" {...field} />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="space-y-1">
                                            ...
                                            <div className="relative">
                                                <Input type={showConfirmPassword ? "text" : "password"} placeholder="••••••••" className="bg-white/5 border-white/10 text-white rounded-xl focus:border-pink-500/50 h-8 md:h-10 text-sm pr-10" {...field} />
