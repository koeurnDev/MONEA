        ...
        <div className="min-h-screen bg-[#FDFCFB] dark:bg-slate-950 p-8 transition-colors">
            ...
            <div className="max-w-5xl mx-auto space-y-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    {/* Create Form */}
                    <Card className="lg:col-span-12 border border-slate-200 dark:border-slate-800 shadow-sm rounded-[2.5rem] overflow-hidden bg-white dark:bg-slate-900">
                    ...
                    <div className="lg:col-span-12 space-y-4">
                        ...
                        {loading ? (
                            ...
                            broadcasts.map((b) => (
                                <Card key={b.id} className="border border-slate-200 dark:border-slate-800 shadow-sm rounded-[2rem] overflow-hidden bg-white dark:bg-slate-900 transition-all hover:scale-[1.01] duration-300">
