...
export default function MobileNav({ mapLink, addToCalendarUrl }: MobileNavProps) {
    return (
        <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-[#0F0F0F]/90 backdrop-blur-md border-t border-[#D4AF37]/30 px-6 py-4 flex justify-between items-center shadow-2xl safe-area-bottom">
            ...
            <a href={addToCalendarUrl} target="_blank" rel="noreferrer" className="flex flex-col items-center hover:scale-105 transition-transform">
                <div className="bg-[#D4AF37]/20 p-3 rounded-full -mt-10 border border-[#D4AF37] shadow-[0_0_15px_rgba(212,175,55,0.4)] backdrop-blur-sm">
