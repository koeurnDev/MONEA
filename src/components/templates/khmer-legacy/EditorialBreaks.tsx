    ...
    return (
        <section id="editorial-breaks" className="w-full bg-white space-y-32 md:space-y-64 overflow-hidden">
                ...
                <div className="w-full md:w-1/2 aspect-[4/5] md:aspect-[4/5] bg-gray-50 relative overflow-hidden order-1 md:order-1">
                    {galleryImages[1 % galleryImages.length] ? (
                        <Image 
                            ...
                            fill 
                            className={`object-cover ${editorialPan1.isDragging ? 'cursor-grabbing' : 'cursor-grab hover:scale-105'} transition-all duration-1500`} 
                            style={{ 
                ...
                <div className="w-full md:w-1/2 aspect-[4/5] bg-gray-50 relative overflow-hidden order-1 md:order-2">
                    {galleryImages[7 % galleryImages.length] ? (
                        <Image 
                            ...
                            fill 
                            className={`object-cover ${editorialPan2.isDragging ? 'cursor-grabbing' : 'cursor-grab hover:scale-105'} transition-all duration-1500`} 
                            style={{ 
            ...
            <div className="w-full py-16 md:py-32 bg-[#FAF9F6]/10 flex flex-col items-center px-4 relative overflow-hidden">
                ...
                <div className="w-full aspect-[16/9] md:aspect-[21/7] overflow-hidden hover:scale-[1.01] transition-all duration-2000 relative shadow-lg rounded-sm md:rounded-none bg-gold/5">
                    {galleryImages[4] ? (
                        <Image 
                            src={galleryImages[4]} 
