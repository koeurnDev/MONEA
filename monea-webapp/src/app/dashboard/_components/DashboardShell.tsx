    ...
    return (
        <div className="flex min-h-screen w-full bg-background font-sans text-foreground print:!bg-white print:!text-black">
            ...
            <main className={cn(
                ...
                {!isDesignPage && (
                    <header className={cn(
                        "h-16 md:h-20 sticky top-0 z-30 flex items-center px-4 md:px-10 justify-between print:hidden transition-all duration-300",
                ...
                <div className={cn(
                    ...
                    !isDesignPage && "p-5 pb-28 md:pb-10 md:pt-6 md:px-10 max-w-7xl",
