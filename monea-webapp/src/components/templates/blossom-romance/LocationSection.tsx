...
export const LocationSection: React.FC<LocationSectionProps> = ({ wedding, primaryColor }) => {
    ...
    return (
        <section className="py-12 px-4 sm:px-6 bg-rose-50/30 font-kantumruy relative overflow-hidden text-center">
            <div className="max-w-md mx-auto space-y-6 relative z-10">
                ...
                <div className="bg-white/90 border border-rose-200/80 rounded-3xl p-5 shadow-sm space-y-4">
                    ...
                    {embedUrl && (
                        <div className="w-full h-56 rounded-2xl overflow-hidden border border-rose-200 shadow-inner">
                            <iframe
                                title="Wedding Map"
                                src={embedUrl}
                    ...
                    <a
                        ...
                        className="w-full py-3 px-4 rounded-xl bg-gradient-to-r from-rose-600 to-pink-600 text-white font-bold text-xs flex items-center justify-center gap-2 shadow-md hover:brightness-105 active:scale-98 transition-all"
                    >
                        <Navigation size={14} />
