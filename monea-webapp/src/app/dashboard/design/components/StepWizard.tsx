...
import { Palette, Loader2, Save, Type, LayoutTemplate, Image as ImageIcon, Settings, Clock, ArrowLeft, ArrowRight, Sparkles } from "lucide-react";
import { useTranslation } from "@/i18n/LanguageProvider";

export const StepWizard = ({ children, currentStep, onSave, loading, setStep }: any) => {
    ...
    return (
        <div className="flex h-full w-full bg-white dark:bg-[#141419] overflow-hidden z-20">
            {/* Left Vertical Sub-Navigation Rail */}
                    ...
                    {STEPS.map((step) => {
                        ...
                        return (
                            <button
                                ...
                                className={clsx(
                                    "flex flex-col items-center justify-center w-[68px] h-[64px] rounded-2xl transition-all duration-200 gap-1.5 px-1 outline-none",
                                    isActive 
            ...
            <div className="flex-1 flex flex-col min-w-0 h-full relative z-20 bg-white dark:bg-[#141419]">
                ...
                {/* Main Content */}
                <div className="flex-1 overflow-y-auto p-5 md:p-6 scrollbar-hide bg-slate-50/30 dark:bg-[#101014]/50 relative">
