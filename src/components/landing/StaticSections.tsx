        ...
        <section className="py-12 bg-white dark:bg-black border-b border-slate-100 dark:border-white/5 relative z-10">
            <div className="container mx-auto px-6 max-w-6xl">
                <p className="text-center text-slate-500 dark:text-white/40 text-xs md:text-sm font-kantumruy uppercase tracking-widest mb-8">
                    គាំទ្រការទទួលចំណងដៃតាមរយៈធនាគារក្នុងស្រុក
                </p>
        ...
        <footer className="bg-slate-50 dark:bg-black py-20 border-t border-slate-200 dark:border-white/10">
            <div className="container mx-auto px-6 text-center">
                <div className="flex flex-col items-center mb-10">
                    ...
                    <h2 className="text-2xl md:text-4xl font-bold font-kantumruy text-slate-800 dark:text-white/10 tracking-[0.5em] uppercase ml-2">MONEA</h2>
                </div>
                ...
                <div className="flex flex-wrap justify-center gap-8 md:gap-16 mb-16 font-kantumruy text-slate-500 dark:text-white/60 uppercase text-xs tracking-[0.2em]">
                    <Link href="#" className="hover:text-slate-900 dark:hover:text-white transition-colors">ទំព័រដើម</Link>
                    <Link href="#features" className="hover:text-slate-900 dark:hover:text-white transition-colors">លក្ខណៈពិសេស</Link>
                    <Link href="#how-it-works" className="hover:text-slate-900 dark:hover:text-white transition-colors">របៀបប្រើប្រាស់</Link>
                    <Link href="#templates" className="hover:text-slate-900 dark:hover:text-white transition-colors">ពុម្ពគំរូ</Link>
                    <Link href="#" className="hover:text-slate-900 dark:hover:text-white transition-colors">ទាក់ទង</Link>
                </div>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between mt-12 pt-8 border-t border-slate-200 dark:border-white/10 text-slate-500 dark:text-white/30 text-xs font-kantumruy">
                    <p>រក្សាសិទ្ធិគ្រប់យ៉ាង © ២០២៦ MONEA</p>
                    <div className="flex gap-4 mt-4 md:mt-0 font-kantumruy">
                        <Link href="/privacy-policy" className="hover:text-slate-900 dark:hover:text-white transition-colors">គោលការណ៍ឯកជនភាព</Link>
                        <span>•</span>
                        <Link href="/terms-and-conditions" className="hover:text-slate-900 dark:hover:text-white transition-colors">លក្ខខណ្ឌប្រើប្រាស់</Link>
                    </div>
                </div>
            </div>
        </footer>
