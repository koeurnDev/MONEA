...
export default function CountdownSection({ targetDate, eventType }: { targetDate: string | Date, eventType?: string }) {
    ...
    const TimeBox = ({ val, label }: { val: number, label: string }) => (
        <div className="flex flex-col items-center mx-2">
            <div className="w-14 h-14 md:w-20 md:h-20 bg-white/10 backdrop-blur-sm shadow-lg rounded-xl flex items-center justify-center border border-white/20 will-change-transform">
